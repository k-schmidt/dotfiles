...
**Status:** DRAFT | **Date:** {YYYY-MM-DD} | **PRD:** [PRD-{feature-name}](../specs/PRD-{feature-name}.md)
...
- Use domain terms from the applicable `docs/CONTEXT.md` as diagram labels. Not "Service A" — use the real name.
