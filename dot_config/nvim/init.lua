...
-- Mason's npm-backed servers need Volta's shims to resolve before any other
-- npm on PATH. nvim inherits PATH from whatever launched it, which is not
-- always a shell that sourced zshrc, so pin it here as well. Only
